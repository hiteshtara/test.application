...
import edu.bu.kuali.kc.award.printing.awardnotice.*;
...
public class BUAwardNoticeXmlStream implements XmlStream {
     ...
     *
     * @param printableBusinessObject printable BO
     ...
     * @param awardNotice award notice object
     * @param awardPrintDO award print DO
     */
    ...
    private void setObligatedChangeHistory(AwardNoticeType awardNotice, BUAwardPrintDO awardPrintDO) {
        ...
        for (BUAwardPrintAmountInfo buAwardPrintAmountInfo : amountInfoList) {
            ...
            //update totals
            obligatedChangeHistory.setObligatedChangeDirectTotal(obligatedChangeHistory.getObligatedChangeDirectTotal().add(obligatedChange.getObligatedChangeDirect()));
            obligatedChangeHistory.setObligatedChangeIndrectTotal(obligatedChangeHistory.getObligatedChangeIndrectTotal().add(obligatedChange.getObligatedChangeIndirect()));
     ...
     * @param departmentAdminsType DA types
     * @param deptAdmins admins
     */
