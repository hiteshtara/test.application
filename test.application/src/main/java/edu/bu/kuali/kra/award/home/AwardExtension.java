...
public class AwardExtension extends KcPersistableBusinessObjectBase implements
    ...
    public String getSteppedUpRate() {
        return steppedUpRate;
    }

    public void setSteppedUpRate(String steppedUpRate) {
        this.steppedUpRate = steppedUpRate;
    }
