...
import edu.bu.kuali.kra.award.printing.BUAwardNoticePrint;
...
public class AwardPrintingServiceImpl extends org.kuali.kra.award.printing.service.impl.AwardPrintingServiceImpl {
    ...
    private BUAwardNoticePrint buAwardNoticePrint;
     ...
     *
     * @param printableBO      Award data using which report is generated
     * @param awardReportType       report to be generated
    ...
    public AttachmentDataSource printAwardReport(
        ...
        switch (awardReportType) {
            ...
            case AWARD_NOTICE_REPORT:
                printable = getBuAwardNoticePrint();
                repoprtFileNamePrefix = ((Award) printableBO).getAwardNumber();
                break;
...
//		String awardNumber = award.getAwardNumber();
    ...
    /**
     * @param awardDeltaPrint the awardDeltaPrint to set
     */
    ...
    /**
     * @param awardNoticePrint the awardNoticePrint to set
     */
    ...
    /**
     * @param moneyAndEndDatesHistoryPrint the moneyAndEndDatesHistoryPrint to set
     */
    ...
    /**
     * @param awardBudgetHierarchyPrint the awardBudgetHierarchyPrint to set
     */
     ...
     * @return the awardNoticePrint
     */
    public BUAwardNoticePrint getBuAwardNoticePrint() {
        return buAwardNoticePrint;
    }

    /**
     * @param buAwardNoticePrint the awardNoticePrint to set
     */
    public void setBuAwardNoticePrint(BUAwardNoticePrint buAwardNoticePrint) {
        this.buAwardNoticePrint = buAwardNoticePrint;
    }

    /**
     * @param awardBudgetHistoryTransactionPrint the awardBudgetHistoryTransactionPrint to set
     */
