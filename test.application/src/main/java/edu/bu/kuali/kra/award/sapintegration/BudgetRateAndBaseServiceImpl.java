...
/**
 * This service implementation helps with calculations related to budget rate and base.
...
public class BudgetRateAndBaseServiceImpl implements BudgetRateAndBaseService {
     ...
     *
     * @see edu.bu.kuali.kra.award.sapintegration.BudgetRateAndBaseService#calculateApplicableFandARate(org.kuali.kra.award.home.Award)
     */
    ...
    public ScaleTwoDecimal calculateApplicableFandARate(Award award) {
        ...
        if (budgetRates != null) {
            ...
            // BU Customization ID: N/A mkousheh 20120208 - Get the maximum applied rate rather than effective date calc
            ...
            /*
                if ((effectiveDate.after(budgetRate.getStartDate()) && effectiveDate.before(budgetRate.getEndDate())) || effectiveDate.equals(budgetRate.getStartDate()) || effectiveDate.equals(budgetRate.getEndDate())) {
                    return budgetRate.getAppliedRate();
                }
            }
            */
        }
