...
public class SubAwardCopyRightsType extends KcPersistableBusinessObjectBase{
    ...
    public String getCopyRightTypeDescription() {
        return copyRightTypeDescription;
    }
    public void setCopyRightTypeDescription(String copyRightTypeDescription) {
        this.copyRightTypeDescription = copyRightTypeDescription;
    }
