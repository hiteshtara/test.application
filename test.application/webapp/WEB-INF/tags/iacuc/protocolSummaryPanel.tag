    ...
    <div class="innerTab-container">
    	<h3>
   			...
   			<span class="subhead-right">
   				<kul:help parameterNamespace="KC-IACUC" parameterDetailType="Document" parameterName="protocolSummaryHelp" altText="Help"/>
			</span>
		</h3>
        ...
        <kra-iacuc:protocolSummary prefix="actionHelper.protocolSummary" protocolSummary="${KualiForm.actionHelper.protocolSummary}" />
